  ...
  <div class="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600">Find and rent the perfect vehicle for your journey</p>
      </div>
        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="flex justify-between items-center">
              <span class="text-2xl font-bold text-indigo-600">${{ car.price }}/day</span>
              <button 
      ...
      <div v-if="selectedCar" class="bg-white rounded-lg shadow-lg p-6 mb-12">
        <h3 class="text-2xl font-bold text-gray-900 mb-4">Selected: {{ selectedCar.name }}</h3>
        <p class="text-gray-600">You can proceed with the rental booking.</p>
      </div>
    </div>
  </div>
</template>
