    ...
    <div class="min-h-screen bg-gray-50 font-sans">
            ...
            >
                ...
                <div class="flex gap-2 flex-wrap">
                    <input
                        ...
                        class="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 w-48"
                    />
                    <select
                            ...
                            >
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    >
                                        ...
                                        <!-- Cancel (pending or active without handover — edge case) -->
                                        <button
                                            v-if="tx.status === 'pending'"
                                            @click="openCancel(tx)"
        ...
        >
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                ...
                <!-- Payment collection (only if not yet paid) -->
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
                ...
                <dl class="space-y-2.5 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd>{{ detailModal.tx?.car?.license_plate }}</dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-gray-500">Tanggal Sewa</dt>
                        <dd>{{ formatDate(detailModal.tx?.start_date) }}</dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-gray-500">Batas Kembali</dt>
                        <dd>{{ formatDate(detailModal.tx?.end_date) }}</dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-gray-500">Durasi</dt>
                        <dd>{{ detailModal.tx?.duration_days }} hari</dd>
                    </div>
                    <div class="flex justify-between">
