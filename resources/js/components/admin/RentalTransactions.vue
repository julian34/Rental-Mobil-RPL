                        ...
                        >
                            ...
                            <td class="px-5 py-3">
                                ...
                                <p class="text-xs text-gray-400 font-normal">
                                    {{
                                        tx.user?.no_telepon ?? tx.user?.username
                                    }}
                                </p>
                            </td>
                            ...
                            <td class="px-5 py-3 text-center">
                                ...
                                <p
                                    v-if="tx.status === 'active' && !tx.paid_at"
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    ...
                                    <dd class="text-xs">
                                        {{
                                            formatDatetime(
                                                detail.handed_over_at,
                                            )
                                        }}
                                    </dd>
                                </div>
                                <div
                                    v-if="detail.actual_return_date"
                                    class="flex justify-between"
                                >
                        ...
                        <div class="border-t border-gray-100 pt-3">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <dd>
                                        Rp {{ formatPrice(detail.total_price) }}
                                    </dd>
                                </div>
                                <div
                                    v-if="detail.late_days > 0"
                                ...
                                >
                                    ...
                                    <dd>
                                        + Rp
                                        {{ formatPrice(detail.late_charge) }}
                                    </dd>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    <dd
                                        class="font-bold text-blue-700 text-base"
                                    >
                                        Rp
                                        {{
                                            formatPrice(
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button
                        ...
                        :class="[
                            'flex-1 py-2.5 rounded-lg text-sm font-semibold transition shadow',
                            payModal.loading
        ...
        >
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                ...
                >
                    ...
                    diserahkan. Setelah dikonfirmasi, status mobil akan berubah
                    menjadi <strong>Disewa</strong>.
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <button
                        ...
                        :disabled="handoverModal.loading"
                        :class="[
                            'flex-1 py-2.5 rounded-lg text-sm font-semibold transition shadow',
    ...
    methods: {
        async fetchTransactions() {
            ...
            try {
                ...
                this.error =
                    "Gagal memuat data transaksi. Pastikan Anda memiliki hak akses yang diperlukan.";
            } finally {
                this.loading = false;
            }
        },
